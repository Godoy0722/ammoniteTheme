    ...
    <div class="row mx-0 mx-xl-auto mt-3 justify-content-between max-w-xl-1200 main-content-layout">
        <div class="col-3 article-section-hidden-xs px-0">
            ...
            <div class="article-section-hidden-xs mb-5">
                ...
                {if !empty($publication->getLocalizedData('supportingAgencies')) && "supportingAgencies"|in_array:$articleMetadataToShow}
                    <div class="row mt-3">
            ...
            {* Discipline *}
            {if !empty($publication->getLocalizedData('disciplines')) && "disciplines"|in_array:$articleMetadataToShow}
            ...
            {* Coverage *}
            {if !empty($publication->getLocalizedData('coverage')) && "coverage"|in_array:$articleMetadataToShow}
            ...
            {* Rights *}
            {if !empty($publication->getLocalizedData('rights')) && "rights"|in_array:$articleMetadataToShow}
            ...
            {* Source *}
            {if !empty($publication->getLocalizedData('source')) && "source"|in_array:$articleMetadataToShow}
            ...
            {* Type *}
            {if !empty($publication->getLocalizedData('type')) && "type"|in_array:$articleMetadataToShow}
        ...
        <div class="col-12 col-sm-8 px-0">
            ...
            {if 'supportingAgencies'|in_array:$articleMetadataToShow && !empty($publication->getLocalizedData('supportingAgencies'))}
